...
<div style="margin: 1rem 0;">
  <video controls playsinline preload="metadata" style="width:100%;max-width:960px;border-radius:8px;background:#000;">
    <source src="Curiosity_in_Machines.mp4?v=1" type="video/mp4">
    <source src="Curiosity_in_Machines.webm?v=1" type="video/webm">
    Your browser does not support the video tag. You can
    <a href="Curiosity_in_Machines.mp4?v=1">download the MP4</a> or
    <a href="Curiosity_in_Machines.webm?v=1">download the WebM</a>.
  </video>
</div>
...
<details open>
  ...
  <div class="dag-mindmap" id="dag-ch19"></div>
  <script type="application/json" id="dag-ch19-data">
  {
    "name": "Exploration & Discovery",
    "children": [
      {"name": "Neuroscience", "children": [
        {"name": "Hippocampus: novelty"},
        {"name": "Dopamine: discovery reward"},
        {"name": "PFC: balance risk/reward"},
        {"name": "DMN: generative wandering"}
      ]},
      {"name": "Core Mechanisms", "children": [
        {"name": "Hypothesis generation"},
        {"name": "Critical evaluation"},
        {"name": "Evolution/refinement"},
        {"name": "Search in idea space"},
      ...
      {"name": "Principle", "children": [
        {"name": "Balance exploration vs exploitation"}
      ]},
      {"name": "Conclusion", "children": [
        {"name": "Guided curiosity accelerates discovery"}
      ]}
    ]
  }
  </script>
